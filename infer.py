...
def infer_main():
    ...
    parser.add_argument('--cfg', default='config/DEdefault.yaml', help='config file path')
    parser.add_argument('--save_dir', default='runs/tmp/attacktarLLVIP/DE', help='fusion result save folder')
