...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = isinstance(val_path, str) and val_path.endswith("KAIST/val.txt")  # COCO dataset
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/tarwuli.yaml", help="dataset.yaml path")
